...
export const ADDRESS_MAX_LENGTH = 20;
...
export const REPORT_AUTO_ESCALATE_THRESHOLD = 3;
export const SAFETY_MUTE_DEFAULT_MINUTES = 60;
export const ADMIN_UIDS: readonly string[] = ["Q55IUn8W53evG5f7El8mQwe74hQ2"];
